            ...
            <div className="w-full flex-col justify-start lg:items-start items-center gap-10 inline-flex">
              <div className="w-full flex-col justify-start lg:items-start items-center gap-4 flex">
                ...
                <p className="text-white text-base font-normal leading-relaxed lg:text-start text-center">
                  Welcome to LegalLoom, the ultimate platform for turning static PDFs into dynamic, interactive learning resources. 
                  Designed for students, professionals, and lifelong learners, LegalLoom combines cutting-edge AI technology with 
